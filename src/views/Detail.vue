<template>
  <div class="detail">
    ...
    <van-goods-action>
      <van-goods-action-icon :to="{name: 'Shopcat'}" icon="bag" text="购物车" :badge="bagCount == 0 ? '' : bagCount" :color="bagCount > 0 ? '#a9643d' : '#646566'" />
      <van-goods-action-icon icon="like" :text="isLike ? '已收藏' : '未收藏'" :color="isLike ? '#a9643d' : '#646566'" @click="toggleLikeProduct" />
      <van-goods-action-button text="加入购物车" color="#cb9966" @click="addShopcat()" />
      <van-goods-action-button text="立即购买" color="#a9643d" @click="buyPro(true)"/>
    </van-goods-action>
